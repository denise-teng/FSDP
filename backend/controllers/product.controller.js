...
//.lean returns a plain js object instead of a mongodb doc
...
export const createProduct = async (req, res) => {
    try {
        ...
        if(image){
            cloudinaryResponse  =await cloudinary.uploaded.upload(image, {folder: 'products'});
        }
...
if(product.image){
    const publicId = product.image.split("/").pop().split(".")[0]; //this will get id of img
    try {
