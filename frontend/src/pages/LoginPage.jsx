...
import { useUserStore } from '../stores/useUserStore';  // Assuming useUserStore is your global state store
...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await login(email, password);  // Assuming your login function is here
      // After successful login, save the token to localStorage
