...
const EventsList = () => {
  const {deleteEvent, toggleFeaturedEvent, events}= useEventStore();
...
<tbody className='bg-gray-800 divide-y divide-gray-700'>
                    {events?.map((event) => (
                        <tr key={event._id} className='hover:bg-gray-700'>
                            ...
                            <td className='px-6 py-4 whitespace-nowrap'>
                                <div className='text-sm text-gray-300'>${event.date.toFixed(2)}</div>
                            </td>
                            <td className='px-6 py-4 whitespace-nowrap'>
                            ...
                            <td className='px-6 py-4 whitespace-nowrap'>
                                <button
                                    ...
                                    className={`p-1 rounded-full ${
                                        event.isNear ? "bg-yellow-400 text-gray-900" : "bg-gray-600 text-gray-300"
